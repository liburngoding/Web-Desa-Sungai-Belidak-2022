...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form /</span> Buat Post</h4>
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Buat Post</h5>
                        ...
                        <form method="post" action="/dashboard/posts" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="category" class="col-sm-2 col-form-label">Kategori<a class="text-danger">
                                        *</a></label>
                                <div class="col-sm-10">
                                    <select name="category_id" id="category_id" placeholder="Pilih Kategori...">
