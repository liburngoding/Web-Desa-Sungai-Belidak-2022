...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form /</span> Tambah Data Warga</h4>
        ...
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="/dashboard/villagers">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0"
                                        ...
                                        is-invalid
                                    @enderror"
                                        id="NIK" name="NIK" placeholder="Isikan NIK" value="{{ old('NIK') }}"
                                        required
                            ...
                            <div class="mb-3 row">
                                <label for="birthdate" class="col-md-2 col-form-label">Tanggal Lahir<a class="text-danger">
                                        *</a></label>
                                <div class="col-md-10">
                                    <input class="form-control" type="date" value="{{ old('birthdate') }}"
                                ...
                                <div class="col-sm-10">
                                    <select name="bloodtype_id" id="bloodtype_id" placeholder="Pilih Golongan Darah..."
                                        ...
                                        @foreach ($bloodtypes as $bloodtype)
                                            @if (old('bloodtype_id') == $bloodtype->id)
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="date" value="{{ old('maritaldate') }}"
                                        id="maritaldate" name="maritaldate" />
                                    @error('maritaldate')
                                        <div class="text-danger">
                                            <i class="menu-icon tf-icons bx bx-alarm-exclamation"></i>{{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-10">
                                    <select name="familyrelation_id" id="familyrelation_id"
                                        ...
                                        @foreach ($familyrelations as $familyrelation)
                                            @if (old('familyrelation_id') == $familyrelation->id)
